    ...
    <>
      <header className="w-full px-4 sm:px-8 md:px-12 lg:px-16 py-4 sm:py-6 md:py-7 flex items-center justify-between select-none relative z-40">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5 md:gap-3">
          ...
          {/* Instagram */}
          <a
            href="https://www.instagram.com/youngdumbandnotbroke"
            target="_blank"
            rel="noopener noreferrer"
            onClick={() => sounds.click()}
            onMouseEnter={() => setHoveredHint("@youngdumbandnotbroke")}
            onMouseLeave={() => setHoveredHint(null)}
            title="Instagram (@youngdumbandnotbroke)"
            className="w-9 h-9 sm:w-10 sm:h-10 rounded-full flex items-center justify-center text-zinc-600 hover:text-pink-600 hover:bg-zinc-200/70 transition-all hover:scale-105"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 fill-current" viewBox="0 0 24 24">
